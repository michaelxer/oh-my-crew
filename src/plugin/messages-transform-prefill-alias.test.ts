...
describe("messages transform assistant prefill alias repair", () => {
  test("#given Anthropic-backed alias providers end with a rejecting assistant tail #when messages transform runs #then it appends a synthetic user recovery turn", async () => {
    const scenarios: Array<{ name: string; providerID: string; modelID: string }> = [
      { name: "opencode anthropic npm alias", providerID: "opencode", modelID: "claude-opus-4-8" },
      { name: "opencode go anthropic npm alias", providerID: "opencode-go", modelID: "claude-opus-4-8" },
      { name: "opencode zen proxy anthropic npm alias", providerID: "opencode-zen-proxy", modelID: "claude-sonnet-4.6" },
      { name: "github copilot claude alias", providerID: "github-copilot", modelID: "claude-sonnet-4.6" },
      { name: "github copilot enterprise claude alias", providerID: "github-copilot-enterprise", modelID: "claude-opus-4.7" },
      { name: "openrouter anthropic namespace", providerID: "openrouter", modelID: "anthropic/claude-opus-4.8" },
      { name: "openrouter tilde anthropic namespace", providerID: "openrouter", modelID: "~anthropic/claude-sonnet-4.6" },
      { name: "openrouter scoped anthropic namespace", providerID: "openrouter", modelID: "@anthropic/claude-opus-4.8" },
      { name: "openrouter colon anthropic namespace", providerID: "openrouter", modelID: "anthropic:claude-sonnet-4.6" },
      { name: "vercel claude alias", providerID: "vercel", modelID: "claude-sonnet-4.6" },
      { name: "generic anthropic dotted namespace", providerID: "litellm", modelID: "anthropic.claude-opus-4-8" },
      { name: "bedrock anthropic dotted id", providerID: "aws-bedrock-anthropic", modelID: "us.anthropic.claude-opus-4-8" },
    ]
